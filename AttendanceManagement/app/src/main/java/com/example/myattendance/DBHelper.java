...
public class DBHelper extends SQLiteOpenHelper {
    ...
    int deleteClass(long cid){
        SQLiteDatabase database = this.getReadableDatabase();
        Log.i("hello",String.valueOf(cid));
    ...
    long addStudent(long cid,String roll,String name){
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(C_ID,cid);
    ...
    int deleteStudent(long sid){
        Log.i("hello","sid="+String.valueOf(sid));
        SQLiteDatabase database = this.getWritableDatabase();
    ...
    Cursor getDistinctMonths(long cid){
        SQLiteDatabase database = this.getReadableDatabase();
        Log.i("hello","dbhelper "+String.valueOf(cid));
        return database.query(STATUS_TABLE_NAME,new String[]{DATE_KEY},C_ID+"="+cid,null,"substr("+DATE_KEY+",4,7)",null,null);//01.04.2024
    }
